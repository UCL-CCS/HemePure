...
#ifndef HEMELB_EXTRACTION_OUTLETSELECTOR_H
#define HEMELB_EXTRACTION_OUTLETSELECTOR_H
...
namespace hemelb
{
  namespace extraction
  {
     ...
     */
    class OutletSelector : public GeometrySelector
    {
      protected:
        /**
...
#endif /* HEMELB_EXTRACTION_OUTLETSELECTOR_H */
